...
class Reservacion extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['estado', 'aplicacion_cliente', 'sillon_servicioid'], 'required'],
            [['fecha', 'promocion_desc', 'promocion_valor', 'promocion_aplicada', 'promocion_op'], 'safe'],
    ...
    {
        return $this->hasOne(User::className(), ['id' => 'salonid']);
    }
}
