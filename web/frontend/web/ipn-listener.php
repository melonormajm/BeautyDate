...
if ($verified) {
    ...
    */
    mail('melonormajm@gmail.com', 'Verified IPN', $listener->getTextReport());
    mail('melonorma@infomed.sld.cu', 'Verified IPN', $listener->getTextReport());
    ...
    invalid IPN.
    */
    mail('melonormajm@gmail.com', 'Invalid IPN', $listener->getTextReport());
    mail('melonorma@infomed.sld.cu', 'Invalid IPN', $listener->getTextReport());
}
