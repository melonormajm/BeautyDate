var MapsGoogle = function () {
    ...
    */
    var mapGeocoding = function () {
        var ltd = $('#ubicacion_latitud').val();
        var lng = $('#ubicacion_longitud').val();
            ...
            GMaps.geocode({
                ...
                callback: function (results, status) {
                    if (status == 'OK') {
                        ...
                        $('#ubicacion_latitud').val(latlng.lat());
                        $('#ubicacion_longitud').val(latlng.lng());
    ...
    return {
        ...
        init: function () {
            ...
            try{
                ...
                console.log("No esta cargado el gmap" +
                "" +
                "" +
                "" +
                "" +
